...
% Diese Vorlage ist lizensiert unter CC BY 4.0 (https://creativecommons.org/licenses/by/4.0/)
%
%% Anmerkungen %%
...
\input{config/citation_numeric} %Dekommentiere diese Linie für numerische Zitate
\usepackage[%
...
\publishers{Verlag}
\dedication{Widmung}
\programme{Bibliotheks- und Informationswissenschaft}
\degree{Master of Arts\\(Library and Information Science)}
...
\begin{document}
    %% Vorderer Teil
    \frontmatter
        %\include{matter/titlepage/titlepage}    %Titelseite ohne Logo
    ...
    \mainmatter
        ...
        \include{content/beispielkapitel}
    %
    %% Hinterer Teil
    ...
    \appendix
    \part*{Appendix}
    \include{appendices/beispielappendix}
    ...
    \include{matter/backmatter/selbststaendigkeitserklaerung}
\end{document}